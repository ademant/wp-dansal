 ...
 * Update URI: https://github.com/ademant/wp-dansal
 */
...
require_once WPD_PLUGIN_DIR . 'includes/class-wpd-blocks.php';
...
final class WPD_Plugin {
	...
	private function __construct() {
		...
		$this->blocks       = new WPD_Blocks( $this->frontend );
